      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-sm-4">
            ...
            <img
              src={'/photos/IMG_0340.webp'}
              alt="social science tower looking up"
            />
          ...
          <div className="col-sm-4">
            <img
              src={'/photos/IMG_1566-02.webp'}
              alt="langston library rooftop patio"
            />
          ...
          <div className="col-sm-4">
            <img
              src={'/photos/IMG_1693_01.webp'}
              alt="krieger hall looking up"
            />
            <img src={'/photos/IMG_0308.webp'} alt="engineering tower" />
            <img
              src={'/photos/IMG_2678-02.webp'}
              alt="rowland and mcgaugh halls"
            />
